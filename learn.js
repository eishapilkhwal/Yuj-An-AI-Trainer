...
function setup() {
  ...
  imgArray[0].src = 'img/mountain.svg';
  imgArray[1] = new Image();
  imgArray[1].src = 'img/tree.svg';
  imgArray[2] = new Image();
  imgArray[2].src = 'img/dog.svg';
  imgArray[3] = new Image();
  imgArray[3].src = 'img/warrior1.svg';
  imgArray[4] = new Image();
  imgArray[4].src = 'img/warrior2.svg';
  imgArray[5] = new Image();
  imgArray[5].src = 'img/chair.svg';
